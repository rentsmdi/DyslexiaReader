...
namespace WPCordovaClassLib.Cordova.Commands
{
    ...
    public class InAppBrowser : BaseCommand
    {
        ...
        private static ApplicationBarIconButton opButton;
                ...
                else
                {
                    ...
                    if (frame != null)
                    {
                        ...
                        if (page != null)
                        {
                            ...
                            opButton = new ApplicationBarIconButton();
                            opButton.Text = "Options";
                            opButton.IconUri = new Uri(baseImageUrl + "appbar.next.rest.png", UriKind.Relative);
                            opButton.Click += new EventHandler(opButton_Click);
                            bar.Buttons.Add(opButton);
        ...
        void opButton_Click(object sender, EventArgs e)
        {
            if (browser != null)
            {
                try
